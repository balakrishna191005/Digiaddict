...
def main():
    ...
    if st.button("Analyze Risk", type="primary"):
        ...
        if prediction == 0:
            st.success("###**Low Risk** \nYour digital usage appears healthy! Good job maintaining balance.")
            risk_color = "green"
            risk_score = probability[0]
        elif prediction == 1:
            st.warning("###**Moderate Risk** \nYour usage patterns suggest emerging dependency. Consider the recommendations below.")
            risk_color = "orange"
            risk_score = probability[1]
        else:  # prediction == 2
            st.error("###**High Risk** \nYour usage indicates potential digital addiction. We recommend taking immediate steps to reduce screen time.")
            risk_color = "red"
        ...
        with st.expander("Additional Resources"):
            ...
            - **Grayscale Mode**: Turn your phone screen to black & white to make it less addictive.
